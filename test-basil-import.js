...
import { parseCSV, detectColumnMapping, processImportedTransactions } from '../src/utils/smartImport.ts'
...
const processed = processImportedTransactions(rows, mapping, existingTransactions)
...
console.log('\nType verification:')
console.log('Coffee Shop should be expense:', processed[0].type === 'expense' ? '✅' : '❌')
console.log('Salary should be income:', processed[1].type === 'income' ? '✅' : '❌')
console.log('Gas should be expense:', processed[2].type === 'expense' ? '✅' : '❌')
console.log('Freelance should be income:', processed[3].type === 'income' ? '✅' : '❌')