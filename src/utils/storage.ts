...
const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: "10", name: "Rent / Mortgage", color: "#F4505F", type: "expense" },
  ...
  { id: "14", name: "Pet Care", color: "#FF7675", type: "expense" },
  { id: "15", name: "Child Care", color: "#A29BFE", type: "expense" },
  { id: "16", name: "Pharmacy", color: "#E17055", type: "expense" },
  { id: "17", name: "Subscription", color: "#6C5CE7", type: "expense" },
  { id: "18", name: "Parking", color: "#74B9FF", type: "expense" },
  { id: "19", name: "Home Improvement", color: "#FD79A8", type: "expense" },
  { id: "20", name: "Personal Business", color: "#FDBB2D", type: "expense" },
  { id: "21", name: "Salary", color: "#5F27CD", type: "income" },
  { id: "22", name: "Freelance", color: "#00D2D3", type: "income" },
  { id: "23", name: "Investments", color: "#FF9F43", type: "income" },
  { id: "24", name: "Refund", color: "#00B894", type: "income" },
  { id: "25", name: "Gift", color: "#FDCB6E", type: "income" },
];
...
export function loadSettings(): UserSettings {
  try {
    ...
    if (data) {
      ...
      if (
        !settings.currency ||
        !SUPPORTED_CURRENCIES.find((c) => c.code === settings.currency.code)
      ) {
