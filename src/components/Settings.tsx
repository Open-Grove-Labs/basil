...
import { formatCurrency, updateCurrency } from "../utils/currency";
...
function Settings() {
  ...
  const handleExportData = async () => {
    ...
    try {
      ...
      link.setAttribute(
        "download",
        `basil-budget-export-${new Date().toISOString().split("T")[0]}.csv`,
      );
        ...
        <div className="settings-section">
          <div className="theme-options">
            <p className="theme-description">
              Choose how Basil should appear, or let it follow your system
              settings.
            </p>
            ...
            <div className="theme-buttons">
              <button
                className={`btn theme-btn ${
                  themePreference === "light" ? "active" : "btn-secondary"
                }`}
              ...
              <button
                className={`btn theme-btn ${
                  themePreference === "dark" ? "active" : "btn-secondary"
                }`}
              ...
              <button
                className={`btn theme-btn ${
                  themePreference === "auto" ? "active" : "btn-secondary"
                }`}
      ...
      <div className="card">
        ...
        <div className="settings-section">
          <div className="app-info">
            <p>
              🌿 <strong>Basil</strong> - Your personal, private, finance
              companion
            </p>
            <p>Version 1.0.0</p>
            <p>
              Built with React, TypeScript, and lots of care for your financial
              wellness.
            </p>
