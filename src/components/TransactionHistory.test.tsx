...
describe('TransactionHistory Component', () => {
  ...
  it('should show totals section with calculated values', () => {
    ...
    expect(getByText(/total income/i) || container.textContent?.includes('Income')).toBeTruthy()
    expect(getByText(/total expenses/i) || container.textContent?.includes('Expenses')).toBeTruthy()
